...
private:
    ...
    // Publisher
    rclcpp::Publisher<custom_serial_interfaces::msg::Receive>::SharedPtr m_receive_pub;
    // Service
    ...
    void sendData(uint8_t func_code, uint16_t id, uint16_t len, const uint8_t* data);
};
}
